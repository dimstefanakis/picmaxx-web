...
export const photoTestPackages = {
  single: {
    ...
    eyebrow: "1 photo",
    promise: "Get a direct score from 20 women.",
    helper: "Best when you already have one photo and want to know if it works.",
    resultCopy: "Score, match signal, and a short read by email.",
  },
  best_of_three: {
    id: "best_of_three",
